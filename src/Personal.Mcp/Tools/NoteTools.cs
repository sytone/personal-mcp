...
public static class NoteTools
{
    ...
    public static object ReadNote(VaultService vault, [Description("Path to the note, e.g., 'Daily/2024-01-15.md'")] string path)
    {
    ...
    public static object CreateNote(VaultService vault,
        IndexService index,
